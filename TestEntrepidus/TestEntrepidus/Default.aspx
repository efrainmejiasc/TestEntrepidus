          ...
          <div class="divBan container">
            <div class="col-md-4 container">
                ...
                <input type="text" id="user" name="user" placeholder="Ingresa Usuario" required oninvalid="setCustomValidity('Rellene esta campo')" oninput="setCustomValidity('')" class="form-control" autocomplete="off"/><br />
                 ...
                 <label class="checkbox-inline"><input type="checkbox" id="check" name="check" required class="btn btn-primary" /> No soy un robot</label><br />
                  <label class="checkbox-inline"><input type="checkbox" id="check2" name="check2" class="btn btn-primary" />Mantener sesion iniciada</label><br /><br />
